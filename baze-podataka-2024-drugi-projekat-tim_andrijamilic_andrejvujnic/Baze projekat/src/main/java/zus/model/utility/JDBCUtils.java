...
public class JDBCUtils {
    ...
    public static List<Prevoz> selectAllFromPrevoziHistory() {
        ...
        try {
            ...
            statement.setInt(1, idOSOBE); // Ispravno postavljanje parametra
            ResultSet resultSet = statement.executeQuery(); // Izvršavanje upita bez prosleđivanja upita kao argumenta
            while (resultSet.next()) {
                int prevozId = resultSet.getInt(1);
